...
def build_recommendations(user_id, selected_location=None):
    '''
    Baut eine sortierte Liste von Pflanzenempfehlungen aus dem PlantCatalog
    Bereits vorhandene Pflanzen des Users werden ausgeschlossen
    Wenn ein Standort gewählt ist, werden nur geeignete oder bedingt geeignete
    Pflanzen empfohlen
    '''
